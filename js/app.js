(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".item-catalog__slider")) new core(".item-catalog__slider", {
                ...
                effect: "fade",
                navigation: {
                    prevEl: ".item-catalog__slider .swiper-button-prev",
                    nextEl: ".item-catalog__slider .swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".filter-constructor__slider")) new core(".filter-constructor__slider", {
                ...
                loop: true,
                pagination: {
                    el: ".filter-constructor .swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".filter-constructor__slider .swiper-button-prev",
                    nextEl: ".filter-constructor__slider .swiper-button-next"
                },
                on: {}
            });
        }
